...
Post.create!([
  {title: "初心者さんにおすすめのスプシ構成", weapon: "スプラシューター", battle: "ナワバリバトル", comment: "汎用性の高い構成です。スプラシューター以外のブキでも使いやすいので使ってみてくださいね。", head_main: 1, head_sub1: 2, head_sub2: 3, head_sub3: 4, body_main: 19, body_sub1: 5, body_sub2: 5, body_sub3: 5, shoes_main: 24, shoes_sub1: 14, shoes_sub2: 13, shoes_sub3: 12, user_id: 1},
  {title: "サブ強化型シャープマーカー編成", weapon: "シャープマーカー", battle: "ガチエリア", comment: "サブインク性能アップをできるだけ積み、遠距離からクイックボム主体で攻める編成です！エリアを取られていても、遠距離から塗れる利点があります。またエリアを取っているときは、前線から遠くの敵をボムで牽制すれば、敵を寄せ付けにくいです！", head_main: 11, head_sub1: 11, head_sub2: 11, head_sub3: 2, body_main: 19, body_sub1: 11, body_sub2: 11, body_sub3: 11, shoes_main: 11, shoes_sub1: 11, shoes_sub2: 11, shoes_sub3: 12, user_id: 1},
  {title: "万能リッターギア", weapon: "リッター4K", battle: "ガチエリア", comment: "頭のサブは0.3分をインク回復にするのもアリです！", head_main: 5, head_sub1: 10, head_sub2: 2, head_sub3: 13, body_main: 22, body_sub1: 1, body_sub2: 1, body_sub3: 1, shoes_main: 25, shoes_sub1: 10, shoes_sub2: 12, shoes_sub3: 13, user_id: 3},
  {title: "スプラ3のエクスプロッシャー用", weapon: "エクスプロッシャー", battle: "ガチホコ", comment: "最大の特徴であるメインをひたすらに撃つ。それがこのブキの運用方法です。", head_main: 1, head_sub1: 12, head_sub2: 12, head_sub3: 13, body_main: 5, body_sub1: 7, body_sub2: 7, body_sub3: 10, shoes_main: 1, shoes_sub1: 3, shoes_sub2: 3, shoes_sub3: 3, user_id: 5},
  {title: "近距離シューター向け万能ギア", weapon: "わかばシューター", battle: "ナワバリバトル", comment: "スペ増を0.2個積んでいますが、安全靴0.1、スパ短0.1に変更しても使いやすいです。", head_main: 5, head_sub1: 14, head_sub2: 6, head_sub3: 7, body_main: 19, body_sub1: 14, body_sub2: 6, body_sub3: 12, shoes_main: 24, shoes_sub1: 14, shoes_sub2: 10, shoes_sub3: 13, user_id: 6},
  {title: "対物デスペナ4K", weapon: "4Kスコープ", battle: "ガチヤグラ", comment: "現環境の4Kに有利なペナアップを採用しています。", head_main: 1, head_sub1: 5, head_sub2: 5, head_sub3: 10, body_main: 22, body_sub1: 6, body_sub2: 6, body_sub3: 10, shoes_main: 25, shoes_sub1: 12, shoes_sub2: 12, shoes_sub3: 13, user_id: 6},
  {title: "イカニン特化", weapon: "スプラシューター", battle: "ガチアサリ", comment: "イカ速0.4はイカニンをちょうど相殺するギア数です。0.1分安全靴に切り替えても差し支えないです。", head_main: 14, head_sub1: 5, head_sub2: 5, head_sub3: 7, body_main: 19, body_sub1: 5, body_sub2: 5, body_sub3: 13, shoes_main: 24, shoes_sub1: 10, shoes_sub2: 10, shoes_sub3: 12, user_id: 7},
  {title: "ガロン好き集まれ", weapon: "96ガロン", battle: "ガチヤグラ", comment: "アクション強化は0.3積んでも0と変わんないので、ブレ軽減のためにつけるなら1か0.4推奨です。", head_main: 14, head_sub1: 5, head_sub2: 5, head_sub3: 5, body_main: 19, body_sub1: 5, body_sub2: 5, body_sub3: 5, shoes_main: 24, shoes_sub1: 13, shoes_sub2: 13, shoes_sub3: 10, user_id: 7},
  {title: "アクロバティックノーチラス", weapon: "ノーチラス47", battle: "ナワバリバトル", comment: "ノーチラスは、扱いが他スピナーと異なりやや難しいが、塗り・キル・補助をすべてこなせる性能があり、自由にロールを切り替えられて非常に楽しい。", head_main: 5, head_sub1: 12, head_sub2: 12, head_sub3: 13, body_main: 14, body_sub1: 4, body_sub2: 4, body_sub3: 7, shoes_main: 4, shoes_sub1: 4, shoes_sub2: 4, shoes_sub3: 4, user_id: 8},
  {title: "マルチミサイル連発型", weapon: "ヴァリアブルローラー", battle: "ナワバリバトル", comment: "マルチミサイルをたくさん打つためのギア", head_main: 17, head_sub1: 6, head_sub2: 6, head_sub3: 6, body_main: 6, body_sub1: 6, body_sub2: 6, body_sub3: 6, shoes_main: 6, shoes_sub1: 6, shoes_sub2: 6, shoes_sub3: 6, user_id: 8},
  {title: "ソイチューバーとかどうですか", weapon: "ソイチューバー", battle: "ガチホコ", comment: "ソイチューバーのみを使ってチャレンジマッチに潜り、S+10まで到達した際に使っていたギア構成です。", head_main: 2, head_sub1: 3, head_sub2: 3, head_sub3: 10, body_main: 6, body_sub1: 12, body_sub2: 12, body_sub3: 10, shoes_main: 5, shoes_sub1: 13, shoes_sub2: 13, shoes_sub3: 7, user_id: 9},
  {title: "復短リトライ型クアッド", weapon: "クアッドホッパーブラック", battle: "ガチアサリ", comment: "敵インクお構い無しの4回スライドの対面力はこのブキの長所です。長所を極限までイカそうと考えた結果、このギア構成になりました。", head_main: 9, head_sub1: 9, head_sub2: 9, head_sub3: 9, body_main: 22, body_sub1: 9, body_sub2: 9, body_sub3: 9, shoes_main: 24, shoes_sub1: 9, shoes_sub2: 9, shoes_sub3: 10, user_id: 10},
  {title: "パブロに必要なのは「サブ性能」", weapon: "パブロ", battle: "ナワバリバトル", comment: "初代スプラからパブロを使い続けた私が思う、スプラ3でのパブロ最適解がこちら。", head_main: 6, head_sub1: 2, head_sub2: 2, head_sub3: 2, body_main: 11, body_sub1: 5, body_sub2: 5, body_sub3: 5, shoes_main: 3, shoes_sub1: 10, shoes_sub2: 12, shoes_sub3: 13, user_id: 11},
  {title: "遠距離好きに", weapon: "14式竹筒銃・甲", battle: "ガチエリア", comment: "今作のスペシャルはモノが多いので対物の刺さる場面は多いです！", head_main: 16, head_sub1: 5, head_sub2: 5, head_sub3: 7, body_main: 22, body_sub1: 1, body_sub2: 3, body_sub3: 2, shoes_main: 25, shoes_sub1: 10, shoes_sub2: 12, shoes_sub3: 13, user_id: 11},
  {title: "クイックジムワイパー", weapon: "ジムワイパー", battle: "ガチホコ", comment: "新武器のジムワイパーギア考察です。", head_main: 11, head_sub1: 3, head_sub2: 3, head_sub3: 10, body_main: 11, body_sub1: 4, body_sub2: 4, body_sub3: 13, shoes_main: 2, shoes_sub1: 4, shoes_sub2: 5, shoes_sub3: 12, user_id: 13},
  {title: "エナドリを回す汎用黒ザップギア", weapon: "N-ZAP85", battle: "ガチホコ", comment: "", head_main: 9, head_sub1: 6, head_sub2: 6, head_sub3: 14, body_main: 8, body_sub1: 4, body_sub2: 4, body_sub3: 4, shoes_main: 24, shoes_sub1: 12, shoes_sub2: 10, shoes_sub3: 7, user_id: 13},
  {title: "新武器LACTを使いたい", weapon: "LACT450", battle: "ナワバリバトル", comment: "", head_main: 18, head_sub1: 5, head_sub2: 5, head_sub3: 5, body_main: 8, body_sub1: 3, body_sub2: 10, body_sub3: 10, shoes_main: 6, shoes_sub1: 6, shoes_sub2: 7, shoes_sub3: 12, user_id: 13},
  {title: "安心安定のカムバデュアル", weapon: "デュアルスイーパー", battle: "ガチヤグラ", comment: "", head_main: 18, head_sub1: 10, head_sub2: 5, head_sub3: 5, body_main: 1, body_sub1: 3, body_sub2: 7, body_sub3: 3, shoes_main: 14, shoes_sub1: 12, shoes_sub2: 12, shoes_sub3: 13, user_id: 15},
  {title: "移動盛りハイド", weapon: "ハイドラント", battle: "ガチアサリ", comment: "前線でガシガシ戦う編成です。", head_main: 18, head_sub1: 5, head_sub2: 4, head_sub3: 5, body_main: 5, body_sub1: 4, body_sub2: 5, body_sub3: 5, shoes_main: 24, shoes_sub1: 7, shoes_sub2: 10, shoes_sub3: 10, user_id: 17},
  {title: "スクスロにおすすめ", weapon: "スクリュースロッシャー", battle: "ガチアサリ", comment: "デスに依存しない安定型のスクスロ編成です。", head_main: 2, head_sub1: 4, head_sub2: 4, head_sub3: 7, body_main: 3, body_sub1: 5, body_sub2: 5, body_sub3: 13, shoes_main: 24, shoes_sub1: 10, shoes_sub2: 10, shoes_sub3: 12, user_id: 19}
])
Favorite.create!([
  ...
  {user_id: 7, post_id: 8},
  {user_id: 7, post_id: 14},
  {user_id: 7, post_id: 9},
  {user_id: 7, post_id: 23},
  {user_id: 7, post_id: 16},
  {user_id: 7, post_id: 26},
  {user_id: 8, post_id: 14},
  {user_id: 8, post_id: 9},
  {user_id: 8, post_id: 8}
])
